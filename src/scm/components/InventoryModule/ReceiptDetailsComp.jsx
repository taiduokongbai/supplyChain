            ...
            <div className="receipt-details-box">
                <Spin spinning={this.props.newState.DetailsPmLoading}>
                    <div className="receipt-info">
                        <p>采购入库单：<span>{formatNullStr(info.orderCode)}</span></p>
                        <div className="receipt-info-list">
                            <p className="sale-return-pemp">状态：<span> {
                                this.statusHandler(formatNullStr(info.status))
                            }</span></p>
                            <p className="sale-return-pemp">收货站点：<span>{formatNullStr(info.deliverySiteName)}</span></p>
                            <p className="sale-return-pemp">收货仓库：<span>{formatNullStr(info.stockName)}</span></p>
                        </div>
                    </div>
