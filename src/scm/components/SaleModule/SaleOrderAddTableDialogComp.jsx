    ...
    selectSaleRow = (selectedRows) => {
        ...
        if (selectedRows) {
            ...
            setFieldsValue({
                ...
                chargeUnitCode: selectedRows.sellUnitCode,//销售单位
                        ...
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="销售数量" className="col-right-pos">
                                {this.getFD('materialNum', {
                                    ...
                                    )}<span className="input-right-pos">{this.state.unitOfMeasurementName}</span>
                            </FormItem>
                        </Col>
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="SPU名称">
                                {this.getFD('spuName', {
                                    initialValue: currVal.spuName || '--',
                                })(
                                    <Input className="no-input-style" disabled />
                                    )}
                            </FormItem>
                        ...
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="计价数量" className="col-right-pos">
                                {this.getFD('valuationQty', {
                                    ...
                                    <Input placeholder="请输入数量" onChange={this.onChangeValuationQty} onBlur={this.onBlurValuationQty} />
                                    )}
                            </FormItem>
                            <FormItem {...formItemLayout2} className="col-right-pos input-right-pos1" style={{ display: this.state.chargeUnitCode ? 'block' : 'none' }}>
                        ...
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="单价" className="col-right-pos">
                                {this.getFD('unitPrice', {
                                    ...
                                    <Input placeholder="请输入单价" onChange={this.onChangeUnitPrice} onBlur={this.onBlurUnitPrice} />
                        ...
                        <Col span={12} className="col-right-pos">
                            <FormItem {...formItemLayout} label="税率">
                                {this.getFD('taxRate', {
                                    ...
                                    <Input disabled={this.props.isTax != 0} onChange={this.onChangeTaxRate} onBlur={this.onBlurTaxRate} />
