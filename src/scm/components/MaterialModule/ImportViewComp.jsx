...
class ImportViewComp extends FormModalComp {
    constructor(props, context) {
        ...
        this.files = {  
            name: 'file',
            action: Urls.COMMON_UPLOAD_FILE_EXcel,//'http://10.99.2.70:9098/pub/common/uploadfile',//Urls.COMMON_UPLOAD_FILE,
        ...
        return (
            <div className="upload-dialog">
                <div className="upload-tiitle">
                    <p>请选择需要导入的文件</p>
                    <a href={prefixPub + "/common/downloadFile?fileUrl="+window.LUX_FILEUP+"/importexcel/物料导入模版.xlsx&fileName=物料导入模版.xlsx"
}>下载《物料导入模版》></a>
                </div>
