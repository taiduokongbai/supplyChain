    ...
    optColRender = (txt, record, index) => {
        ...
        let opts = [
            ...
            },
            {
                ...
                show: editingIndex == null && displayBtn && record.syncFlag == 2,
            },
            {
                title: '图片上传',
                fun: () => onDelete(record,index),
                show: editingIndex == null && proDesignBomDetailsInfoStore.init.status != 0,
            },
        ];
...
@observer
export default class DetailsEditTableComp extends Component {
    constructor(props, context) {
        super(props, context);
        this.store = detailsEditTable;
        this.columns = [
            {
                title: '导入类型',
            ...
            },
            {
                ...
                obj:{
                    render: (text, record, index) =>{
                        if(record.syncFlag=="2" && proDesignBomDetailsInfoStore.errorPage){
                            return (
